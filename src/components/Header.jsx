                        ...
                        <nav className="flex gap-8">
                            <PopoverGroup className="hidden gap-3 lg:flex ">
                                ...
                                {NAVIGATION.header.map((subLink, j) => (
                                    <Popover key={j} >
                                        <PopoverButton className="flex flex-wrap justify-center items-center text-xs font-semibold text-dark">
                                            <Link className="pr-2 flex-wrap hover:text-accent transition hover:underline"
                                                href={subLink.href}
                        ...
                        <div className="mt-6 flow-root">
                            <div className="-my-6 divide-y divide-gray-500/10">
                                <div className="space-y-2 py-6">
                                    ...
                                    {NAVIGATION.header.map((subLink, j) => (
                                        <Popover key={j} >
                                            <PopoverButton className="flex justify-center items-center text-xl font-semibold text-dark">
                                                <Link
